...
export const bookBacks = {
  //felsefe
  Platon:
    "..... bu kitap, Platon felsefisini, metafiziğidoğa felsefesi, epistomolojisi, etiği ve siyaset felsefesinin temel noktaları üzerinden ele alınırken, Platon'un önemli eserlerinden seçme bölümler sunuyor",
  Nietzsche:
  ...
  HarariHomoDeus:
    "Hayvanlardan Tanrılara: Sapiens kitabıyla insan türünün dünyaya nasıl egemen olduğunu anlatan Harari, Homo Deus’ta çarpıcı öngörüleriyle yarınımızı ele alıyor. İnsanlığın ölümsüzlük, mutluluk ve tanrısallık peşindeki yolculuğunu bilim, tarih ve felsefe ışığında incelediği bu çalışmasında, insanın bambaşka bir türe, Homo deus’a evrildiği bir gelecek kurguluyor. Yola “önemsiz bir hayvan” olarak çıkan Homo sapiens, tanrılar katına ulaşmak uğruna kendi sonunu mu hazırlıyor? Homo sapiens nasıl oldu da evrenin insan türünün etrafında döndüğünü iddia eden hümanist öğretiye inandı?",
  YalınAlpayTarih:
